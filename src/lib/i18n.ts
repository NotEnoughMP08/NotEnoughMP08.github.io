    ...
    ko: {
        ...
        about: {
            ...
            worksList: [
                ...
                "프로젝트팀 ‘리브라(Libra)’ 키보디스트/작곡가",
                "비주얼 노벨 '우리집 반려소녀' OST '그날의 햇살처럼(Feat. 라연)' 스트링 편곡 참여",
                "버츄얼 유튜버 ‘NyuMoon’ Main BGM (2곡) 음원 총괄 제작 참여",
    ...
    en: {
        ...
        about: {
            ...
            worksList: [
                ...
                "Keyboardist / composer in project team 'Libra'.",
                "Visual novel 'Our House Pet Girl' OST – 'Like That Day's Sunshine (Feat. Ra-yeon)' string arrangement.",
                "Lead producer for two main BGM tracks for VTuber 'NyuMoon'.",
    ...
    ja: {
        ...
        about: {
            ...
            worksList: [
                ...
                "ビジュアルノベル『Our House Pet Girl』OST『Like That Day's Sunshine (Feat. Ra-yeon)』ストリング編曲を担当。",
                "プロジェクトチーム『Libra』のキーボーディスト／作曲家。",
                "VTuber『NyuMoon』のメインBGM（2曲）の総合制作に参加。",
    ...
    zh: {
        ...
        about: {
            ...
            worksList: [
                ...
                "视觉小说《Our House Pet Girl》OST《Like That Day's Sunshine (Feat. Ra-yeon)》弦乐编曲。",
                "《蔚蓝档案》非官方祭典『몰루제』编曲、键盘演奏及舞台企划。",
                "项目组『Libra』键盘手／作曲家。",
                "统筹制作虚拟 YouTuber『NyuMoon』两首主 BGM。",
